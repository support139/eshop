...
function show(element, messages, tmpRule) {
	...
	document.getElementById(messages[tmpRule]).className += " error";
	return false;
}

document.getElementById("name").onfocus = function() {
	document.getElementById("name").className = "";
	document.getElementById("nameRequired").className = 'errorSpan nameErrorSpan';
	document.getElementById("nameRegex").className = 'errorSpan nameErrorSpan';
}

document.getElementById("email").onfocus = function() {
	document.getElementById("email").className = "";
	document.getElementById("emailRequired").className = 'errorSpan emailErrorSpan';
	document.getElementById("emailRegex").className = 'errorSpan emailErrorSpan';
}

document.getElementById("password").onfocus = function() {
	document.getElementById("password").className = "";
	document.getElementById("passwordRequired").className = 'errorSpan passwordErrorSpan';
	document.getElementById("passwordRegex").className = 'errorSpan passwordErrorSpan';
}
