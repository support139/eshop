				...
				<div class="col-sm-4">
					...
					<div class="signup-form"><!--sign up form-->
						...
						<form action="Signup" id="signUpForm" method="post">
							...
							<span id="loginServer" class="errorSpan loginErrorSpan showError">${formBean.login.errorMessage}</span>
							
							<input type="password" placeholder="Password" id="password" name="password" value="${formBean.password.value}"/>
							...
							<span id="nameServer" class="errorSpan nameErrorSpan showError">${formBean.name.errorMessage}</span>
							
							<input type="text" placeholder="Surname" id="surname" name="surname" value="${formBean.surname.value}"/>
							...
							<span id="surnameServer" class="errorSpan surnameErrorSpan showError">${formBean.surname.errorMessage}</span>
